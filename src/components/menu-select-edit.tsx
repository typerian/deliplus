...
interface IdClientProps {
  orden: Pedidos;
}

const SelectMenuEdit: FC<IdClientProps> = ({ orden }) => {
  ...
  const [pedidoList, setPedidoList] = useState<PedidoInfo[]>(orden.pedido);
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (e.target.name === "detalles")
      setPedido((prev) => ({ ...prev, detalles: e.target.value }));
        ...
        <Dialog>
          ...
          <DialogContent>
            <DialogHeader>
              <Button
                variant="outline"
                onClick={async () => await db.pedidos.delete(orden.id)}
              >
                Eliminar Orden
              </Button>
            </DialogHeader>
            ...
            <div className="">
              <div className="flex items-center justify-center mb-2">
                <div className="flex items-center gap-2 text-lg text-[#333]">
                  <span
                    ...
                    className="hover:cursor-pointer flex items-center w-8 h-8 bg-gray-100 p-2 rounded"
                  >
                    <svg
              ...
              <div className="flex w-full">
                ...
                <span
                  ...
                  className="cursor-pointer flex items-center justify-center w-2/12 bg-gray-100 p-2 rounded"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-3.5 fill-current"
